...
- All experimental lanes: 100.00% precision (Wilson lower 64.57%), 10.94% coverage
- Shipped sentence policy: 100.00% precision (Wilson lower 64.57%), 10.94% coverage
...
- Latency p50/p95/p99: 0 / 0 / 178 ms
