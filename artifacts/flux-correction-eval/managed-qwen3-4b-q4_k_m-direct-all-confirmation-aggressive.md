...
- All experimental lanes: 100.00% precision (Wilson lower 94.17%), 96.88% coverage
- Shipped sentence policy: 100.00% precision (Wilson lower 94.17%), 96.88% coverage
- Paragraph lane enabled: no (failed its locked precision gate)
- Candidate availability: 89.47%
- Protected changes: 0
- Calls / 1,000 words (adversarial corpus): 126.7
- Calls / 1,000 words (realistic suppression/cache audit): 7.6 (pass; target ≤ 20)
- Latency p50/p95/p99: 517 / 740 / 1148 ms
