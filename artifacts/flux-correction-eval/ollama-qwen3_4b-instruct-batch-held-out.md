...
- All experimental lanes: 100.00% precision (Wilson lower 99.04%), 85.87% coverage
- Shipped sentence policy: 100.00% precision (Wilson lower 99.04%), 89.77% coverage
...
- Latency p50/p95/p99: 268 / 371 / 476 ms
- Order stability: 96.55%
- Provider failures: 0
