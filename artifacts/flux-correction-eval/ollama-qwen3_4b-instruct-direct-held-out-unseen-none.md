...
- All experimental lanes: 80.00% precision (Wilson lower 49.02%), 10.00% coverage
- Shipped sentence policy: 80.00% precision (Wilson lower 49.02%), 10.00% coverage
...
- Latency p50/p95/p99: 0 / 175 / 184 ms
