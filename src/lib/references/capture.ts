...
export { CAPTURE_PREFIX, CAPTURE_EXT, SUPP_PREFIX, SUPP_SEP, isCaptureFile, isSupplementCapture, parseSupplementCapture, parseFluxCapture, captureSlug, doiFromSlug } from "../../../electron/captureRules.js";
