...
export const numericProperties: Record<NumericProperty, NumericDescriptor> = {
  ...
  fontSize: { label: 'font size (pt)', shortLabel: 'Size (pt)', key: 'e', group: 'Text', step: .5, min: 1, softMax: 72, read: e => e.type === 'text' ? e.fontSize * .75 : undefined },
  lineHeight: { label: 'line height', shortLabel: 'Line height', key: 'l', group: 'Text', step: .05, min: .5, softMax: 3, read: e => e.type === 'text' ? e.lineHeight ?? 1.2 : undefined },
  cornerRadius: { label: 'corner radius', shortLabel: 'Radius', key: 'u', group: 'Fill', step: 1, min: 0, softMax: 120, read: e => e.type === 'rect' || e.type === 'path' ? e.cornerRadius ?? 0 : undefined },
};
