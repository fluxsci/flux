...
Two documents govern all agent work in this repo. Read both before doing anything substantive,
in this order:

1. **`docs/AGENT_ENGINEERING_GUIDE-RUNNING.md`** — the living engineering guide (architecture,
